import { getChecksumFromArrayBuffer } from './s.js'
 ...
 * @returns {ArrayBuffer}
 */
export const getPixelsFrame = options => {
  ...
  const SIZE_PER_PIXEL = settings.type === 'rgb' ? 3 : 4 // Bytes needed for one pixel
  const PIXEL_AMOUNT = settings.data.length / SIZE_PER_PIXEL // how many pixels does the message contain?
